        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link katahijau" href="/pages/ereport">Expense Reports<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item ">
...
<div class="bg ereport">
    <div class="container lihat">
        <div class="row">
            <div class="col-md-4">
                <div class="card-header dua shadow-lg bg-white">
                    <p class="card-title text-xs font-weight-bold text-uppercase mb-1" id="atas"><b>Total money that has been spent</b></p>
